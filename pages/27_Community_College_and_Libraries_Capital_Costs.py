...
from modules.community_college_and_libraries_capital_costs import hcc_capital_costs, hcl_capital_costs
...
with expander:
    ...
    st.dataframe(hcc_capital_costs().style.format('$ {:,.2f}'))
...
with expander2:
    ...
    st.dataframe(hcl_capital_costs().style.format('$ {:,.2f}'))